...
def get_model_path(window_length, predictor_type, use_batch_norm):
    ...
    return 'weights/sse_stock/{}/window_{}/{}/checkpoint.ckpt'.format(predictor_type, window_length, batch_norm_str)
...
def get_result_path(window_length, predictor_type, use_batch_norm):
    if use_batch_norm:
        ...
        batch_norm_str = 'no_batch_norm'
    return 'results/sse_stock/{}/window_{}/{}/'.format(predictor_type, window_length, batch_norm_str)
...
#history, abbreviation = read_stock_history(filepath='utils/datasets/stocks_history_target.h5')
    ...
    with h5py.File( 'utils/datasets/stock_history.h5', 'r') as f:
        history = f['history'][:]
    ...
    # setup environment
    env = PortfolioEnv(target_history, target_stocks, steps=965, window_length=window_length)
